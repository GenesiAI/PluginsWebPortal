...
const SectionThree = () => {
  return (
    <Container
      maxWidth="lg"
      className="my-10 grid grid-cols-1 grid-rows-6 place-content-center place-items-center gap-6 md:grid-cols-2 md:grid-rows-3"
    >
      <SectionThreeTemplate
        title="For everyone"
        imageClassName="col-start-1 row-start-2 md:row-start-1 bg-primary"
        skillsClassName="col-start-1 row-start-1 md:col-start-2 md:row-start-1"
        image={"IMAGE"}
        skills={[
          "Intuitive interface",
          "No code",
      ...
      <SectionThreeTemplate
        ...
        imageClassName="col-start-1 row-start-4 md:col-start-2 md:row-start-2 bg-primary"
      ...
      <SectionThreeTemplate
        ...
        skillsClassName="col-start-1 row-start-5 md:col-start-2 md:row-start-3"
        image={"IMAGE32"}
        skills={[
