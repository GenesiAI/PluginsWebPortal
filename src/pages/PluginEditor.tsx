                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                error={
                                    plugin.nameForHuman &&
                                        (plugin.nameForHuman.length > 20 || !/^[a-zA-Z ]+$/.test(plugin.nameForHuman))
                                        ? true
                                        : false
                                }
                                helperText={
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                error={
                                    plugin.nameForModel &&
                                        (plugin.nameForModel.length > 50 || !/^[a-zA-Z0-9]+$/.test(plugin.nameForModel))
                                        ? true
                                        : false
                                }
                                helperText={
                        ...
                        <Grid item xs={12} sm={12}>
                            <TextField
                                ...
                                error={
                                    plugin.descriptionForHuman && plugin.descriptionForHuman.length > 100 ? true : undefined
                                }
                                helperText={
                                    plugin.descriptionForHuman && plugin.descriptionForHuman.length > 100
                        ...
                        <Grid item xs={12} sm={12}>
                            <TextField
                                ...
                                error={
                                    plugin.descriptionForModel && plugin.descriptionForModel.length > 8000 ? true : false
                                }
                                helperText={
                                    plugin.descriptionForModel && plugin.descriptionForModel.length > 8000
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                error={
                                    (plugin.contactEmail && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(plugin.contactEmail))
                                        ? true
                                        : undefined
                                }
                                helperText={
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField
                                ...
                                error={
                                    (plugin.legalInfoUrl && !/^https?:\/\/.+/.test(plugin.legalInfoUrl))
                                        ? true
                                        : undefined
                                }
                                helperText={
